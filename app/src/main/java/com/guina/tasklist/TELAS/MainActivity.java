...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBtnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent CadastrarTarefaintent = new Intent(MainActivity.this, CadastrarTarefaActivity.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                Intent editTarefaIntent = new Intent(MainActivity.this, AlterarTarefaActivity.class);
    ...
    public void atualizarLista(){
        ...
        ListarTarefasAdapter adapter = new ListarTarefasAdapter(this, tarefas);
