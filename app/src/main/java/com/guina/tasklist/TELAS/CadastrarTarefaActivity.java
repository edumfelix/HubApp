...
public class CadastrarTarefaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EdtTarefa = (EditText) findViewById(R.id.til_descricao);
        ...
        btnSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (validarDescricao()) {
                    ...
                    tarefa.setDescricao(EdtTarefa.getText().toString().trim());
    ...
    public boolean validarDescricao(){
        if (EdtTarefa.getText().toString().trim().equals("")){
            EdtTarefa.setError("O nome da tarefa não pode estar em branco!");
            return false;
        }
        EdtTarefa.setError(null);
        return true;
    }
